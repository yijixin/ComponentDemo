...
public class PreferenceUtil {
    ...
    //读取
    public static Object getObjInfo(Context context,String key) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public static <K, V> boolean putHashMapData(Map<K, V> map, String name) {
        boolean result;
        SharedPreferences sp = BaseAplication.getAppContext().getSharedPreferences(name, Context.MODE_PRIVATE);
